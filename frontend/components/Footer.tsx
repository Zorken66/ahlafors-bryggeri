        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Hantverk i varje droppe sedan 1854. Mikrobryggeri i hjärtat av den historiska spinnerifabriken i Alafors.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>Alafors Fabriker</li>
              <li>3 mil norr om Göteborg</li>
              <li className="pt-2">
                <a href="mailto:info@ahlaforsbryggerier.se" className="hover:text-amber-500 transition-colors">
