...
export default function HeaderNav({ navItems }: { navItems: NavItem[] }) {
      ...
      <nav className="container-custom relative">
        <div className="flex items-center justify-between py-4">
          <Link href="/" className="flex items-center space-x-2">
            <div className="text-2xl font-serif font-bold tracking-tight md:text-3xl">
              <span className="text-amber-500">Ahlafors</span>
              <span className="text-white"> Bryggerier</span>
            </div>
          </Link>
